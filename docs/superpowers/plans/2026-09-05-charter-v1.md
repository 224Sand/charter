...
- Produces: `Signoff`, `Assignment`, `BuildState`, `TranscriptEvent`, and `RecordStore` with `init(roster, idea)`, `exists()`, `load_roster()`, `load_state()`, `save_state(state)`, `append_signoff(s)`, `signoffs()`, `append_event(e)`, `events()`, `CHARTER_DIR = ".charter"`
...
def store(tmp_path, roster):
    ...
    s.init(roster, idea="a governed build")
    return s
...
class RecordStore:
    ...
    def init(self, roster: Roster, idea: str) -> None:
        ...
        self.save_state(BuildState(
            phase=roster.roles and "requirements" or "requirements",
            task_id="T-1"))
...
def council(tmp_path):
    ...
    store.init(roster, idea="a governed build")
...
class Handlers:
    ...
    def init(self, idea: str, methodology: str = "scrum") -> str:
        try:
            roster = roster_for(methodology, load_methodologies(), load_roles())
